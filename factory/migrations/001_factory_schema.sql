...
-- Run this against the FACTORY's own Supabase project — never against
...
-- ============================================================
-- 5. secrets_vault — encrypted Vercel/Supabase master tokens (§11 item 1)
...
-- Per-tenant Supabase service-role keys are also stored here, keyed as
-- 'tenant:<tenant_id>:supabase_service_key', so they never sit in
